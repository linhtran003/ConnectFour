...
#define PLAYER_1_COLOR LCD_COLOR_YELLOW
#define PLAYER_2_COLOR LCD_COLOR_RED

#define BOARD_BOTTOM 300
#define BOARD_TOP (BOARD_BOTTOM - BOARD_HEIGHT)
#define BOARD_HEIGHT ((COIN_DIAMETER * NUM_ROWS) + (GAP_BETWEEN_COINS * NUM_GAPS))
#define BOARD_LEFT 15
#define SCREEN_MIDDLE (LCD_PIXEL_WIDTH/2)
...
#define COIN_DIAMETER (COIN_RADIUS * 2)
#define GAP_BETWEEN_COINS 5
#define NUM_GAPS 5

//#define COIN_DISTANCE_FROM_RADII 25
